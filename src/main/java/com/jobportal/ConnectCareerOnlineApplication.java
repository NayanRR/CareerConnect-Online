...
public class ConnectCareerOnlineApplication implements CommandLineRunner {

	private final Logger LOG = LoggerFactory.getLogger(ConnectCareerOnlineApplication.class);
	...
	public static void main(String[] args) {
		SpringApplication.run(ConnectCareerOnlineApplication.class, args);
	}
